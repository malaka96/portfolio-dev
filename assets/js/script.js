...
const currentWorking = "MediLinkLK – Medicine Availability & Shortage Alert Platform";
...
const projects = [
  {
    ...
    source: "https://mega.nz/folder/My9nUJKC#2__GhGrwI9_FMM8_tdAZnA",
    code: [
      "// mobile app that allows uses to post their qutoes and thoughts",
      "@override",
      ...
      "      color: postColors[widget.colorId],",
  ...
  {
    title: "Fullstack-Note-Application",
    technology: "Spring-boot",
    tags: ["Fullstack", "spring-boot", "Flutter", "Android", "web", "react"],
    source: "https://github.com/malaka96/note-application-backend-spring-boot",
    code: [
      "// Fullstack application (mobile, web) for save notes and manage them",
